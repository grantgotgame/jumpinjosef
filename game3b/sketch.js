...
function draw() {
	...
	//character dies if canyon is touched
	...
	if (collectable.isFound == false) {
		...
		fill(217, 166, 28);
		rect(collectable.x_pos - collectable.size * 0.1, collectable.y_pos - collectable.size * 0.3, collectable.size * 0.2, collectable.size * 0.6);
	}
